"""
/home/siem/siem-solution/services/writer/config.py

Настройки writer-сервиса:
  - Redis (стрим siem:filtered + ключ last_id)
  - ClickHouse (таблица siem.events)
...
class WriterSettings:
    ...
    writer_last_id_key: str
    batch_size: int

    @classmethod
    def load(cls) -> "WriterSettings":
        ...
        writer_last_id_key = os.getenv("SIEM_WRITER_LAST_ID_KEY", "siem:writer:last_id")
        batch_size = int(os.getenv("SIEM_WRITER_BATCH_SIZE", "200"))
        ...
        return cls(
            ...
            writer_last_id_key=writer_last_id_key,
